...
import com.example.tendertest1.base.BaseRecyclerViewHolder;
import com.example.tendertest1.model.Models;

public class HomeViewHolder extends BaseRecyclerViewHolder<Models> {
    private ClickListener listener;

    private TextView tittle, content, deadLine, cost;
    private ImageView companyLogo;

    public HomeViewHolder(@NonNull View itemView, ClickListener listener) {
        super(itemView);
    ...
    protected void bind(final Models myModels) {
        Glide
                .with(itemView)
